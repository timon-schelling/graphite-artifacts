...
fn function_6() {
    ...
    if (_e135.x <= 0.0031308f) {
        phi_7254_ = (_e135.x * 12.92f);
    } else {
        phi_7254_ = ((1.055f * pow(_e135.x, 0.41666666f)) - 0.055f);
    }
    let _e150 = phi_7254_;
    if (_e135.y <= 0.0031308f) {
        phi_7266_ = (_e135.y * 12.92f);
    } else {
        phi_7266_ = ((1.055f * pow(_e135.y, 0.41666666f)) - 0.055f);
    }
    let _e157 = phi_7266_;
    if (_e135.z <= 0.0031308f) {
        phi_7278_ = (_e135.z * 12.92f);
    } else {
        phi_7278_ = ((1.055f * pow(_e135.z, 0.41666666f)) - 0.055f);
    }
    let _e164 = phi_7278_;
    ...
    if (_e167 <= 0.04045f) {
        phi_7298_ = (_e167 * 0.07739938f);
    } else {
        phi_7298_ = pow(((_e167 + 0.055f) * 0.94786733f), 2.4f);
    }
    let _e180 = phi_7298_;
    if (_e170 <= 0.04045f) {
        phi_7307_ = (_e170 * 0.07739938f);
    } else {
        phi_7307_ = pow(((_e170 + 0.055f) * 0.94786733f), 2.4f);
    }
    let _e187 = phi_7307_;
    if (_e173 <= 0.04045f) {
        phi_7316_ = (_e173 * 0.07739938f);
    } else {
        phi_7316_ = pow(((_e173 + 0.055f) * 0.94786733f), 2.4f);
    }
    let _e194 = phi_7316_;
...
fn function_8() {
    var phi_7448_: no_std_types_color_Color;

    let _e118 = frag_coord_16;
    let _e132 = textureLoad(image_input, vec2<u32>(select(select(u32(_e118.x), 0u, (_e118.x < 0f)), 4294967295u, (_e118.x > 4294967000f)), select(select(u32(_e118.y), 0u, (_e118.y < 0f)), 4294967295u, (_e118.y > 4294967000f))), 0i);
    if (_e132.w == 0f) {
        phi_7448_ = no_std_types_color_Color(_e132.x, _e132.y, _e132.z, 1f);
    } else {
        phi_7448_ = no_std_types_color_Color((_e132.x / _e132.w), (_e132.y / _e132.w), (_e132.z / _e132.w), 1f);
    }
    let _e144 = phi_7448_;
...
fn function_10() {
    ...
    let _e134 = textureLoad(image_input_1, vec2<u32>(select(select(u32(_e118.x), 0u, (_e118.x < 0f)), 4294967295u, (_e118.x > 4294967000f)), select(select(u32(_e118.y), 0u, (_e118.y < 0f)), 4294967295u, (_e118.y > 4294967000f))), 0i);
    if (_e134.x <= 0.0031308f) {
        phi_7574_ = (_e134.x * 12.92f);
    } else {
        phi_7574_ = ((1.055f * pow(_e134.x, 0.41666666f)) - 0.055f);
    }
    let _e148 = phi_7574_;
    if (_e134.y <= 0.0031308f) {
        phi_7586_ = (_e134.y * 12.92f);
    } else {
        phi_7586_ = ((1.055f * pow(_e134.y, 0.41666666f)) - 0.055f);
    }
    let _e155 = phi_7586_;
    if (_e134.z <= 0.0031308f) {
        phi_7598_ = (_e134.z * 12.92f);
    } else {
        phi_7598_ = ((1.055f * pow(_e134.z, 0.41666666f)) - 0.055f);
    }
    let _e162 = phi_7598_;
    ...
    if (_e172 == _e181) {
        ...
        if (_e183 <= 0.5f) {
            phi_7620_ = ((_e181 - _e172) / (_e181 + _e172));
        } else {
            phi_7620_ = ((_e181 - _e172) / ((2f - _e181) - _e172));
        }
        let _e194 = phi_7620_;
        phi_7623_ = _e194;
    }
    ...
    if (_e148 >= _e155) {
        ...
        if _e198 {
            phi_7634_ = ((_e155 - _e162) / (_e181 - _e172));
        } else {
            phi_7634_ = f32();
        }
        let _e203 = phi_7634_;
        phi_7637_ = _e203;
        phi_7638_ = select(true, false, _e198);
    } else {
        phi_7637_ = f32();
        phi_7638_ = true;
    }
    ...
    if _e208 {
        if (_e155 >= _e148) {
            ...
            if _e210 {
                phi_7652_ = (2f + ((_e162 - _e148) / (_e181 - _e172)));
            } else {
                phi_7652_ = f32();
            }
            let _e216 = phi_7652_;
            phi_7655_ = _e216;
            phi_7656_ = select(true, false, _e210);
        } else {
            phi_7655_ = f32();
            phi_7656_ = true;
        }
        ...
        let _e221 = phi_7656_;
        if _e221 {
            phi_7664_ = (4f + ((_e148 - _e155) / (_e181 - _e172)));
        } else {
            phi_7664_ = _e219;
        }
        let _e227 = phi_7664_;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            if (_e235 != _e235) {
                ...
                phi_8267_ = (_e201 <= _e235);
            }
            let _e239 = phi_8267_;
            if _e202 {
                phi_8282_ = true;
            } else {
                phi_8282_ = (_e194 >= _e187);
            }
            let _e244 = phi_8282_;
            ...
            if (_e245 != _e245) {
                ...
                phi_8297_ = (_e201 >= _e245);
            }
            let _e249 = phi_8297_;
            if _e202 {
                phi_8312_ = true;
            } else {
                phi_8312_ = (_e194 <= _e187);
            }
            let _e255 = phi_8312_;
...
fn function_14() {
    ...
    let _e146 = phi_10618_;
    if (_e146 != _e146) {
        phi_8575_ = true;
    } else {
        phi_8575_ = (0.0001f >= _e146);
    }
    let _e150 = phi_8575_;
            ...
            switch _e125 {
                ...
                case 1: {
                    ...
                    if (_e121.color.red != _e121.color.red) {
                        ...
                        phi_10245_ = (_e1759.red <= _e121.color.red);
                    }
                    let _e1765 = phi_10245_;
                    ...
                    if (_e121.color.green != _e121.color.green) {
                        ...
                        phi_10263_ = (_e1759.green <= _e121.color.green);
                    }
                    let _e1776 = phi_10263_;
                    ...
                    if (_e121.color.blue != _e121.color.blue) {
                        ...
                        phi_10281_ = (_e1759.blue <= _e121.color.blue);
                    }
                    let _e1787 = phi_10281_;
                    ...
                    if (_e1656.red == 1f) {
                        ...
                        if (_e121.color.red == 0f) {
                            ...
                            if (_e1662 != _e1662) {
                                ...
                                phi_10156_ = (1f <= _e1662);
                            }
                            let _e1666 = phi_10156_;
                            phi_10142_ = (1f - select(_e1662, 1f, _e1666));
                        }
                        let _e1670 = phi_10142_;
                        phi_10145_ = _e1670;
                    }
                    let _e1672 = phi_10145_;
                    ...
                    if (_e1656.green == 1f) {
                        ...
                        if (_e121.color.green == 0f) {
                            ...
                            if (_e1682 != _e1682) {
                                ...
                                phi_10187_ = (1f <= _e1682);
                            }
                            let _e1686 = phi_10187_;
                            phi_10173_ = (1f - select(_e1682, 1f, _e1686));
                        }
                        let _e1690 = phi_10173_;
                        phi_10176_ = _e1690;
                    }
                    let _e1692 = phi_10176_;
                    ...
                    if (_e1656.blue == 1f) {
                        ...
                        if (_e121.color.blue == 0f) {
                            ...
                            if (_e1702 != _e1702) {
                                ...
                                phi_10218_ = (1f <= _e1702);
                            }
                            let _e1706 = phi_10218_;
                            phi_10204_ = (1f - select(_e1702, 1f, _e1706));
                        }
                        let _e1710 = phi_10204_;
                        phi_10207_ = _e1710;
                    }
                    let _e1712 = phi_10207_;
                ...
                case 6: {
                    ...
                    if (_e121.color.red != _e121.color.red) {
                        ...
                        phi_10077_ = (_e1564.red >= _e121.color.red);
                    }
                    let _e1570 = phi_10077_;
                    let _e1571 = select(_e121.color.red, _e1564.red, _e1570);
                    let _e1573 = select(_e1571, 0f, (_e1571 < 0f));
                    if (_e121.color.green != _e121.color.green) {
                        phi_10095_ = true;
                    } else {
                        phi_10095_ = (_e1564.green >= _e121.color.green);
                    }
                    let _e1581 = phi_10095_;
                    let _e1582 = select(_e121.color.green, _e1564.green, _e1581);
                    let _e1584 = select(_e1582, 0f, (_e1582 < 0f));
                    if (_e121.color.blue != _e121.color.blue) {
                        phi_10113_ = true;
                    } else {
                        phi_10113_ = (_e1564.blue >= _e121.color.blue);
                    }
                    let _e1592 = phi_10113_;
                ...
                case 8: {
                    ...
                    if (_e121.color.red == 1f) {
                        ...
                        let _e1473 = phi_9991_;
                        phi_9980_ = select(_e1469, 1f, _e1473);
                    }
                    let _e1476 = phi_9980_;
                    ...
                    if (_e121.color.green == 1f) {
                        ...
                        if (_e1485 != _e1485) {
                            ...
                            phi_10016_ = (1f <= _e1485);
                        }
                        let _e1489 = phi_10016_;
                        phi_10005_ = select(_e1485, 1f, _e1489);
                    }
                    let _e1492 = phi_10005_;
                    ...
                    if (_e121.color.blue == 1f) {
                        ...
                        if (_e1501 != _e1501) {
                            ...
                            phi_10041_ = (1f <= _e1501);
                        }
                        let _e1505 = phi_10041_;
                        phi_10030_ = select(_e1501, 1f, _e1505);
                    }
                    let _e1508 = phi_10030_;
                ...
                case 11: {
                    ...
                    if (_e154 <= 0.5f) {
                        phi_9925_ = (_e1364.red * (2f * _e154));
                    } else {
                        phi_9925_ = (1f - ((1f - _e1364.red) * (2f - (2f * _e154))));
                    }
                    let _e1375 = phi_9925_;
                    let _e1377 = select(_e1375, 0f, (_e1375 < 0f));
                    if (_e155 <= 0.5f) {
                        phi_9943_ = (_e1364.green * (2f * _e155));
                    } else {
                        phi_9943_ = (1f - ((1f - _e1364.green) * (2f - (2f * _e155))));
                    }
                    let _e1390 = phi_9943_;
                    let _e1392 = select(_e1390, 0f, (_e1390 < 0f));
                    if (_e156 <= 0.5f) {
                        phi_9961_ = (_e1364.blue * (2f * _e156));
                    } else {
                        phi_9961_ = (1f - ((1f - _e1364.blue) * (2f - (2f * _e156))));
                    }
                    let _e1405 = phi_9961_;
                ...
                case 12: {
                    ...
                    if (_e121.color.red <= 0.5f) {
                        phi_9822_ = (_e1263.red - (((1f - (2f * _e121.color.red)) * _e1263.red) * (1f - _e1263.red)));
                    } else {
                        if (_e1263.red <= 0.25f) {
                            phi_9835_ = (((((16f * _e1263.red) - 12f) * _e1263.red) + 4f) * _e1263.red);
                        } else {
                            phi_9835_ = sqrt(_e1263.red);
                        }
                        let _e1277 = phi_9835_;
                        phi_9822_ = (_e1263.red + (((2f * _e121.color.red) - 1f) * (_e1277 - _e1263.red)));
                    }
                    let _e1288 = phi_9822_;
                    let _e1290 = select(_e1288, 0f, (_e1288 < 0f));
                    if (_e121.color.green <= 0.5f) {
                        phi_9858_ = (_e1263.green - (((1f - (2f * _e121.color.green)) * _e1263.green) * (1f - _e1263.green)));
                    } else {
                        if (_e1263.green <= 0.25f) {
                            phi_9871_ = (((((16f * _e1263.green) - 12f) * _e1263.green) + 4f) * _e1263.green);
                        } else {
                            phi_9871_ = sqrt(_e1263.green);
                        }
                        let _e1306 = phi_9871_;
                        phi_9858_ = (_e1263.green + (((2f * _e121.color.green) - 1f) * (_e1306 - _e1263.green)));
                    }
                    let _e1317 = phi_9858_;
                    let _e1319 = select(_e1317, 0f, (_e1317 < 0f));
                    if (_e121.color.blue <= 0.5f) {
                        phi_9894_ = (_e1263.blue - (((1f - (2f * _e121.color.blue)) * _e1263.blue) * (1f - _e1263.blue)));
                    } else {
                        if (_e1263.blue <= 0.25f) {
                            phi_9907_ = (((((16f * _e1263.blue) - 12f) * _e1263.blue) + 4f) * _e1263.blue);
                        } else {
                            phi_9907_ = sqrt(_e1263.blue);
                        }
                        let _e1335 = phi_9907_;
                        phi_9894_ = (_e1263.blue + (((2f * _e121.color.blue) - 1f) * (_e1335 - _e1263.blue)));
                    }
                    let _e1346 = phi_9894_;
                ...
                case 13: {
                    ...
                    if (_e121.color.red <= 0.5f) {
                        phi_9763_ = (_e1204.red * (2f * _e121.color.red));
                    } else {
                        phi_9763_ = (1f - ((1f - _e1204.red) * (2f - (2f * _e121.color.red))));
                    }
                    let _e1216 = phi_9763_;
                    let _e1218 = select(_e1216, 0f, (_e1216 < 0f));
                    if (_e121.color.green <= 0.5f) {
                        phi_9781_ = (_e1204.green * (2f * _e121.color.green));
                    } else {
                        phi_9781_ = (1f - ((1f - _e1204.green) * (2f - (2f * _e121.color.green))));
                    }
                    let _e1232 = phi_9781_;
                    let _e1234 = select(_e1232, 0f, (_e1232 < 0f));
                    if (_e121.color.blue <= 0.5f) {
                        phi_9799_ = (_e1204.blue * (2f * _e121.color.blue));
                    } else {
                        phi_9799_ = (1f - ((1f - _e1204.blue) * (2f - (2f * _e121.color.blue))));
                    }
                    let _e1248 = phi_9799_;
                    ...
                    if (_e121.color.red <= 0.5f) {
                        ...
                        if (_e1101 == 1f) {
                            ...
                            if (_e1085.red == 0f) {
                                ...
                                let _e1109 = phi_9611_;
                                phi_9580_ = (1f - select(_e1105, 1f, _e1109));
                            }
                            let _e1113 = phi_9580_;
                            phi_9583_ = _e1113;
                        }
                        let _e1115 = phi_9583_;
                        phi_9585_ = _e1115;
                    } else {
                        if (_e1085.red == 1f) {
                            phi_9567_ = 1f;
                            ...
                            let _e1097 = phi_9596_;
                            phi_9567_ = select(_e1093, 1f, _e1097);
                        }
                        let _e1100 = phi_9567_;
                        phi_9585_ = _e1100;
                    }
                    let _e1117 = phi_9585_;
                    ...
                    if (_e121.color.green <= 0.5f) {
                        ...
                        if (_e1137 == 1f) {
                            ...
                            if (_e1085.green == 0f) {
                                ...
                                let _e1145 = phi_9676_;
                                phi_9645_ = (1f - select(_e1141, 1f, _e1145));
                            }
                            let _e1149 = phi_9645_;
                            phi_9648_ = _e1149;
                        }
                        let _e1151 = phi_9648_;
                        phi_9650_ = _e1151;
                    } else {
                        if (_e1085.green == 1f) {
                            phi_9632_ = 1f;
                            ...
                            let _e1133 = phi_9661_;
                            phi_9632_ = select(_e1129, 1f, _e1133);
                        }
                        let _e1136 = phi_9632_;
                        phi_9650_ = _e1136;
                    }
                    let _e1153 = phi_9650_;
                    ...
                    if (_e121.color.blue <= 0.5f) {
                        ...
                        if (_e1173 == 1f) {
                            ...
                            if (_e1085.blue == 0f) {
                                ...
                                let _e1181 = phi_9741_;
                                phi_9710_ = (1f - select(_e1177, 1f, _e1181));
                            }
                            let _e1185 = phi_9710_;
                            phi_9713_ = _e1185;
                        }
                        let _e1187 = phi_9713_;
                        phi_9715_ = _e1187;
                    } else {
                        if (_e1085.blue == 1f) {
                            phi_9697_ = 1f;
                            ...
                            let _e1169 = phi_9726_;
                            phi_9697_ = select(_e1165, 1f, _e1169);
                        }
                        let _e1172 = phi_9697_;
                        phi_9715_ = _e1172;
                    }
                    let _e1189 = phi_9715_;
                ...
                case 15: {
                    ...
                    if (_e121.color.red <= 0.5f) {
                        phi_9518_ = (((2f * _e121.color.red) + _e1029.red) - 1f);
                    } else {
                        phi_9518_ = (((2f * _e121.color.red) - 1f) + _e1029.red);
                    }
                    let _e1040 = phi_9518_;
                    let _e1042 = select(_e1040, 0f, (_e1040 < 0f));
                    if (_e121.color.green <= 0.5f) {
                        phi_9534_ = (((2f * _e121.color.green) + _e1029.green) - 1f);
                    } else {
                        phi_9534_ = (((2f * _e121.color.green) - 1f) + _e1029.green);
                    }
                    let _e1055 = phi_9534_;
                    let _e1057 = select(_e1055, 0f, (_e1055 < 0f));
                    if (_e121.color.blue <= 0.5f) {
                        phi_9550_ = (((2f * _e121.color.blue) + _e1029.blue) - 1f);
                    } else {
                        phi_9550_ = (((2f * _e121.color.blue) - 1f) + _e1029.blue);
                    }
                    let _e1070 = phi_9550_;
                ...
                case 16: {
                    ...
                    if (_e121.color.red <= 0.5f) {
                        ...
                        if (_e952.red != _e952.red) {
                            ...
                            phi_9408_ = (_e963 <= _e952.red);
                        }
                        let _e967 = phi_9408_;
                        phi_9382_ = select(_e952.red, _e963, _e967);
                    } else {
                        let _e957 = ((2f * _e121.color.red) - 1f);
                        if (_e952.red != _e952.red) {
                            phi_9393_ = true;
                        } else {
                            phi_9393_ = (_e957 >= _e952.red);
                        }
                        let _e961 = phi_9393_;
                        phi_9382_ = select(_e952.red, _e957, _e961);
                    }
                    let _e970 = phi_9382_;
                    ...
                    if (_e121.color.green <= 0.5f) {
                        ...
                        if (_e952.green != _e952.green) {
                            ...
                            phi_9453_ = (_e985 <= _e952.green);
                        }
                        let _e989 = phi_9453_;
                        phi_9427_ = select(_e952.green, _e985, _e989);
                    } else {
                        let _e979 = ((2f * _e121.color.green) - 1f);
                        if (_e952.green != _e952.green) {
                            phi_9438_ = true;
                        } else {
                            phi_9438_ = (_e979 >= _e952.green);
                        }
                        let _e983 = phi_9438_;
                        phi_9427_ = select(_e952.green, _e979, _e983);
                    }
                    let _e992 = phi_9427_;
                    ...
                    if (_e121.color.blue <= 0.5f) {
                        ...
                        if (_e952.blue != _e952.blue) {
                            ...
                            phi_9498_ = (_e1007 <= _e952.blue);
                        }
                        let _e1011 = phi_9498_;
                        phi_9472_ = select(_e952.blue, _e1007, _e1011);
                    } else {
                        let _e1001 = ((2f * _e121.color.blue) - 1f);
                        if (_e952.blue != _e952.blue) {
                            phi_9483_ = true;
                        } else {
                            phi_9483_ = (_e1001 >= _e952.blue);
                        }
                        let _e1005 = phi_9483_;
                        phi_9472_ = select(_e952.blue, _e1001, _e1005);
                    }
                    let _e1014 = phi_9472_;
                ...
                case 17: {
                    ...
                    let _e890 = phi_5049_;
                    if (_e121.color.red <= 0.5f) {
                        phi_9319_ = (((2f * _e121.color.red) + _e890.red) - 1f);
                    } else {
                        phi_9319_ = (((2f * _e121.color.red) - 1f) + _e890.red);
                    }
                    let _e901 = phi_9319_;
                    let _e903 = select(1f, 0f, (_e901 < 0.5f));
                    let _e905 = select(_e903, 0f, (_e903 < 0f));
                    if (_e121.color.green <= 0.5f) {
                        phi_9343_ = (((2f * _e121.color.green) + _e890.green) - 1f);
                    } else {
                        phi_9343_ = (((2f * _e121.color.green) - 1f) + _e890.green);
                    }
                    let _e918 = phi_9343_;
                    let _e920 = select(1f, 0f, (_e918 < 0.5f));
                    let _e922 = select(_e920, 0f, (_e920 < 0f));
                    if (_e121.color.blue <= 0.5f) {
                        phi_9367_ = (((2f * _e121.color.blue) + _e890.blue) - 1f);
                    } else {
                        phi_9367_ = (((2f * _e121.color.blue) - 1f) + _e890.blue);
                    }
                    let _e935 = phi_9367_;
                ...
                case 21: {
                    ...
                    if (_e741.red == 0f) {
                        ...
                        phi_9207_ = (_e741.red / _e121.color.red);
                    }
                    let _e747 = phi_9207_;
                    ...
                    if (_e741.green == 0f) {
                        ...
                        phi_9218_ = (_e741.green / _e121.color.green);
                    }
                    let _e757 = phi_9218_;
                    ...
                    if (_e741.blue == 0f) {
                        ...
                        phi_9229_ = (_e741.blue / _e121.color.blue);
                    }
                    let _e767 = phi_9229_;
                ...
                case 22: {
                    ...
                    if (_e483 != _e483) {
                        ...
                        phi_8956_ = (_e156 >= _e483);
                    }
                    let _e487 = phi_8956_;
                    if _e479 {
                        phi_8971_ = true;
                    } else {
                        phi_8971_ = (_e155 <= _e154);
                    }
                    let _e491 = phi_8971_;
                    ...
                    if (_e492 != _e492) {
                        ...
                        phi_8986_ = (_e156 <= _e492);
                    }
                    let _e496 = phi_8986_;
                    let _e498 = (select(_e483, _e156, _e487) - select(_e492, _e156, _e496));
                    if (_e121.color.red <= 0.0031308f) {
                        phi_9004_ = (_e121.color.red * 12.92f);
                    } else {
                        phi_9004_ = ((1.055f * pow(_e121.color.red, 0.41666666f)) - 0.055f);
                    }
                    let _e510 = phi_9004_;
                    if (_e121.color.green <= 0.0031308f) {
                        phi_9016_ = (_e121.color.green * 12.92f);
                    } else {
                        phi_9016_ = ((1.055f * pow(_e121.color.green, 0.41666666f)) - 0.055f);
                    }
                    let _e517 = phi_9016_;
                    if (_e121.color.blue <= 0.0031308f) {
                        phi_9028_ = (_e121.color.blue * 12.92f);
                    } else {
                        phi_9028_ = ((1.055f * pow(_e121.color.blue, 0.41666666f)) - 0.055f);
                    }
                    let _e524 = phi_9028_;
                    ...
                    if (_e510 >= _e517) {
                        ...
                        if _e547 {
                            phi_9064_ = ((_e517 - _e524) / (_e543 - _e534));
                        } else {
                            phi_9064_ = f32();
                        }
                        let _e552 = phi_9064_;
                        phi_9067_ = _e552;
                        phi_9068_ = select(true, false, _e547);
                    } else {
                        phi_9067_ = f32();
                        phi_9068_ = true;
                    }
                    ...
                    if _e557 {
                        if (_e517 >= _e510) {
                            ...
                            if _e559 {
                                phi_9082_ = (2f + ((_e524 - _e510) / (_e543 - _e534)));
                            } else {
                                phi_9082_ = f32();
                            }
                            let _e565 = phi_9082_;
                            phi_9085_ = _e565;
                            phi_9086_ = select(true, false, _e559);
                        } else {
                            phi_9085_ = f32();
                            phi_9086_ = true;
                        }
                        ...
                        let _e570 = phi_9086_;
                        if _e570 {
                            phi_9094_ = (4f + ((_e510 - _e517) / (_e543 - _e534)));
                        } else {
                            phi_9094_ = _e568;
                        }
                        let _e576 = phi_9094_;
                ...
                case 23: {
                    ...
                    if _e220 {
                        ...
                        phi_8675_ = (_e121.color.green >= _e121.color.red);
                    }
                    let _e223 = phi_8675_;
                    ...
                    if (_e224 != _e224) {
                        ...
                        phi_8690_ = (_e121.color.blue >= _e224);
                    }
                    let _e229 = phi_8690_;
                    if _e220 {
                        phi_8705_ = true;
                    } else {
                        phi_8705_ = (_e121.color.green <= _e121.color.red);
                    }
                    let _e233 = phi_8705_;
                    ...
                    if (_e234 != _e234) {
                        ...
                        phi_8720_ = (_e121.color.blue <= _e234);
                    }
                    let _e238 = phi_8720_;
                    let _e240 = (select(_e224, _e121.color.blue, _e229) - select(_e234, _e121.color.blue, _e238));
                    if (_e154 <= 0.0031308f) {
                        phi_8738_ = (_e154 * 12.92f);
                    } else {
                        phi_8738_ = ((1.055f * pow(_e154, 0.41666666f)) - 0.055f);
                    }
                    let _e252 = phi_8738_;
                    if (_e155 <= 0.0031308f) {
                        phi_8750_ = (_e155 * 12.92f);
                    } else {
                        phi_8750_ = ((1.055f * pow(_e155, 0.41666666f)) - 0.055f);
                    }
                    let _e259 = phi_8750_;
                    if (_e156 <= 0.0031308f) {
                        phi_8762_ = (_e156 * 12.92f);
                    } else {
                        phi_8762_ = ((1.055f * pow(_e156, 0.41666666f)) - 0.055f);
                    }
                    let _e266 = phi_8762_;
                    ...
                    if (_e252 >= _e259) {
                        ...
                        if _e289 {
                            phi_8798_ = ((_e259 - _e266) / (_e285 - _e276));
                        } else {
                            phi_8798_ = f32();
                        }
                        let _e294 = phi_8798_;
                        phi_8801_ = _e294;
                        phi_8802_ = select(true, false, _e289);
                    } else {
                        phi_8801_ = f32();
                        phi_8802_ = true;
                    }
                    ...
                    if _e299 {
                        if (_e259 >= _e252) {
                            ...
                            if _e301 {
                                phi_8816_ = (2f + ((_e266 - _e252) / (_e285 - _e276)));
                            } else {
                                phi_8816_ = f32();
                            }
                            let _e307 = phi_8816_;
                            phi_8819_ = _e307;
                            phi_8820_ = select(true, false, _e301);
                        } else {
                            phi_8819_ = f32();
                            phi_8820_ = true;
                        }
                        ...
                        let _e312 = phi_8820_;
                        if _e312 {
                            phi_8828_ = (4f + ((_e252 - _e259) / (_e285 - _e276)));
                        } else {
                            phi_8828_ = _e310;
                        }
                        let _e318 = phi_8828_;
